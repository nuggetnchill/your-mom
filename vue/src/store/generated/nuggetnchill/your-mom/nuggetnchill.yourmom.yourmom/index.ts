...
import { Params } from "./module/types/yourmom/params"
import { Post } from "./module/types/yourmom/post"
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: nuggetnchill.yourmom.yourmom initialized!')
